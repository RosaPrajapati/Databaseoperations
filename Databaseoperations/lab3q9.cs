...
namespace RosaDatabaseoperations
{
    class Tourism
    {
        static string connectionString = "Server=localhost;Database=csharp;Uid=root;Pwd=;";
        ...
        static void Main(string[] args)
        {
            ...
            /* // Update a Destination
             UpdateDestination(7, "Pokhara Adventure Tour", "Enjoy paragliding and scenic views.", 4);
 */
