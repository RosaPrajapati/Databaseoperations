...
class NepaliLibrary
{
    static string connectionString = "Server=localhost;Database=librarydb;User ID=root;Password=yourpassword;";
    ...
    static void Main(string[] args)
    {
        ...
        // Update a Book
        UpdateBook(2, "Seto Bagh (Updated)", "Diamond Shumsher Rana", 1974);
